Extraction of invoice information to be organized in “xls” format with the help of a detection model (YOLO11n) and an OCR model (https://huggingface.co/docs/transformers/model_doc/trocr).
